...
public class Quiz2 extends AppCompatActivity implements TextToSpeech.OnInitListener{
    float x1,x2,y1,y2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opt1 = findViewById(R.id.button4);
        opt2 = findViewById(R.id.button5);
        opt3 = findViewById(R.id.button6);
        ...
        opt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Quiz2.this, Congrats.class);
                startActivity(i);
                if (tts != null) {
                    tts.stop();
                    tts.shutdown();
    ...
    public boolean onTouchEvent(MotionEvent touchEvent){
        switch(touchEvent.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if(x1<x2){
                    Intent i = new Intent(Quiz2.this, Slider6.class);
                    startActivity(i);
                    if (tts != null) {
                        tts.stop();
                        tts.shutdown();
